...
> [!CAUTION]
> Don't use both the Firebase Installation ID APIs and the deprecated registration token APIs for registration management at the same time. We recommend using Firebase Installation IDs (FIDs) to segment or target your app instances.

> [!TIP]
> See Best practices for FCM registration management for tips on managing registrations.
