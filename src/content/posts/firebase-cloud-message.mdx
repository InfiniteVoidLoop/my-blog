...
> [!TIP]
> To learn how web push notifications work under the hood—including Service Worker lifecycles, VAPID key cryptography, read my in-depth guide on [Web Push Notification](/posts/web-push-notification).
...
{
    Console.Write("🔑 Enter FCM Device Token / FID from Web Client: ");
